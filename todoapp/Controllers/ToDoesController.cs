...
namespace todoapp.Controllers
{
    public class ToDoesController : Controller
    {
        ...
        private IEnumerable<ToDo> GetMyToDoes()
        {
            ...
            ViewBag.Percent = 100f * ((float)completedCount / (float)myToDoes.Count());
        ...
        public ActionResult Create([Bind(Include = "Id,Desc,IsDone")] ToDo toDo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Desc,IsDone")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
